...
for i in range(diagonal_num):
    raw_np_file = np.load('./data_set/log_preprocess/log_subtraction_prepro/diagonal_preprocess_log_' + str(i) + '.npy')
...
for index, single_diagonal in enumerate(raw_data_lst):
    ...
    path = './Ensemble_CP_log_w_subtraction/diagonal_' + str(index)
